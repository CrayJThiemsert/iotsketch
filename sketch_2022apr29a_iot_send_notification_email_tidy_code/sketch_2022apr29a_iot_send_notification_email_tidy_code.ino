...
bool processSendNotificationEmail(String notifyType) {
  ...
  if(notifyType.equals("humidity")) {
    ...
    if(gHumidity < gNotifyHumidLower) {
      messageBody = "Humidity " + String(gHumidity) + " is lower than " + String(gNotifyHumidLower) + ".<br><br>Regards,<br>IoT System";  
    } else {
      if(gHumidity > gNotifyHumidHigher) {
        messageBody = "Humidity " + String(gHumidity) + " is higher than " + String(gNotifyHumidHigher) + ".<br><br>Regards,<br>IoT System";  
      }
    }
    ...
    if(notifyType.equals("temperature")) {
      ...
      if(gTemperature < gNotifyTempLower) {
        messageBody = "Temperature " + String(gTemperature) + " is lower than " + String(gNotifyTempLower) + ".<br><br>Regards,<br>IoT System";  
      } else {
        if(gTemperature > gNotifyTempHigher) {
          messageBody = "Temperature " + String(gTemperature) + " is higher than " + String(gNotifyTempHigher) + ".<br><br>Regards,<br>IoT System";  
        }
      }
    }
  }
