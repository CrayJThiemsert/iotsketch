...
void processDeepSleepWaitForWakeUpButton(void);
// Buttons
...
//    processDeepSleep();
    // Test to sleep and wakeup by push button
    processDeepSleepWaitForWakeUpButton();
...
bool loadInternalConfig(void) {
  ...
  Serial.println(".");
  Serial.println("sketch_oct26a_iot_updated_library_before_scenario2and3");
